...
const DEMO_USER = {
  ...
  mood: 'happy',
  moodPercent: 85,
  date_of_birth: new Date('2005-05-15'), // 19 yrs old
...
async function seedDemo() {
  try {
    ...
    // 1. Delete any existing demo user
    ...
    // 3. Create tasks (today + some completed)
    const tasks = [
    ...
    // 6. Social posts (to show in Social Buzz)
    const posts = [
      {
        user: user._id,
    ...
    // 8. Opportunities (for the Opportunities Hub)
    const opportunities = [
      {
