...
// ===== SUBSCRIPTION API (duplicates resolved) =====
...
createCheckoutSession: (tier) => fetch(`${API_BASE}/subscription/create-checkout`, {
  method: 'POST',
  headers: authHeaders(),
  body: JSON.stringify({ tier }),
}).then(handleResponse),

startFreeTrial: (tier) => fetch(`${API_BASE}/subscription/start-trial`, {
  method: 'POST',
  headers: authHeaders(),
  body: JSON.stringify({ tier }),
}).then(handleResponse),
...
// =============================================
//          🔥 GENERIC GET / POST (for Orbit & others)
// =============================================

  /**
   * Generic GET request
   * @param {string} url - endpoint without base (e.g. '/orbit/progress')
   */
  get: (url) => fetch(`${API_BASE}${url}`, { headers: authHeaders() }).then(handleResponse),

  /**
   * Generic POST request
   * @param {string} url - endpoint without base
